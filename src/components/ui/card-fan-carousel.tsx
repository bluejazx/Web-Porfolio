...
export interface CardItem {
  ...
  alt?: string;
  linkUrl?: string;
  // Any extra data your custom `render` needs.
  [key: string]: unknown;
}
...
interface SocialCardsProps {
  cards: CardItem[];
  /**
   * Optional custom renderer. When provided, each fan card renders this instead
   * of the default <img>, while ALL the gsap fan/hover/pagination logic below
   * stays identical. Lets us fan DOM tiles (monograms + text) rather than images.
   */
  render?: (card: CardItem, index: number) => ReactNode;
}
...
export default function SocialCards({ cards, render }: SocialCardsProps) {
